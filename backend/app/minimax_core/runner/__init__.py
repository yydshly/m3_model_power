...
_SUPPORTED_CAPABILITIES = {"lyrics-gen", "tts-sync", "voice-list", "tts-async", "image-t2i", "chat-openai", "music-gen", "image-i2i", "file-upload", "file-list", "file-retrieve", "file-content"}
